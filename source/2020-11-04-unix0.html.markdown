...
usuarios, que en lugar de manejar muchisimos detalles que deben proramarse en 
lenguaje de máquina, emplean ordenes cortas y sencillas que manejan
conceptos abstractos más fáciles de entender para nosotros.

El vìdeo disponible en <https://www.youtube.com/watch?v=pvaPaWyiuLA> muestra
en operación Unix0 en un PDP-7 real.   No es fácil tener una de esas máquinas para
volver a ver la forma de trabajo en 1969 para desarrollar Unix0, pero es posible
emular ese computador, compilar las fuentes en ensamblador de Unix0 y verlo operando
en un computador actual (la pantalla obrará como el papel en el que escribía el teletipo
y el teclado como el teclado del teletipo del video).
...
(incluyendo  una implementación de compilador de lenguaje B en lenguaje B).
El resultado se ha publicado como código abierto en https://github.com/DoctorWkt/pdp7-unix
